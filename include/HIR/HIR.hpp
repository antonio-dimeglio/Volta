...
struct HIRVarDecl : HIRStmt {
    ...
    std::string toString() const override { return "HIRVarDecl"; }
};
...
struct HIRExprStmt : HIRStmt {
    ...
    void accept(HIRStmtVisitor& visitor) override;
    std::string toString() const override { return "HIRExprStmt"; }
};
...
struct HIRReturnStmt : HIRStmt {
    ...
    void accept(HIRStmtVisitor& visitor) override;
    std::string toString() const override { return "HIRReturnStmt"; }
};
...
struct HIRIfStmt : HIRStmt {
    ...
    void accept(HIRStmtVisitor& visitor) override;
    std::string toString() const override { return "HIRIfStmt"; }
};
...
struct HIRWhileStmt : HIRStmt {
    ...
    void accept(HIRStmtVisitor& visitor) override;
    std::string toString() const override { return "HIRWhileStmt"; }
};
...
struct HIRBlockStmt : HIRStmt {
    ...
    void accept(HIRStmtVisitor& visitor) override;
    std::string toString() const override { return "HIRBlockStmt"; }
};
...
struct HIRBreakStmt : HIRStmt {
    ...
    void accept(HIRStmtVisitor& visitor) override;
    std::string toString() const override { return "HIRBreakStmt"; }
};
...
struct HIRContinueStmt : HIRStmt {
    ...
    void accept(HIRStmtVisitor& visitor) override;
    std::string toString() const override { return "HIRContinueStmt"; }
};
...
struct HIRFnDecl : HIRStmt {
    ...
    void accept(HIRStmtVisitor& visitor) override;
    std::string toString() const override { return "HIRFnDecl: " + name; }
};
...
struct HIRExternBlock : HIRStmt {
    ...
    void accept(HIRStmtVisitor& visitor) override;
    std::string toString() const override { return "HIRExternBlock"; }
};
...
struct HIRImportStmt : HIRStmt {
    ...
    void accept(HIRStmtVisitor& visitor) override;
    std::string toString() const override { return "HIRImportStmt"; }
};
...
struct HIRStructDecl : HIRStmt {
    ...
    void accept(HIRStmtVisitor& visitor) override;
    std::string toString() const override { return "HIRStructDecl"; }
};
struct HIRProgram {
    std::vector<std::unique_ptr<HIRStmt>> statements;
