...
void runFile(const std::string& filename) {
    try {
        ...
        BytecodeGenerator bytecodeGenerator(*irModule);
        auto bytecode = bytecodeGenerator.generate();

        std::cout << "\n=== Generated Bytecode ===\n";
        std::cout << "Bytecode size: " << bytecode.size() << " bytes\n";
        //BytecodeDisassembler bd;
        //std::cout << bd.disassemble(bytecode.data(), bytecode.size()) << "\n";

        VM vm;
        auto res = vm.execute(bytecode.data(), bytecode.size());
